...
import {
  faArrowLeft, faArrowRight, faArrowUpRightFromSquare, faBars, faCakeCandles, faCamera,
  faChampagneGlasses, faCheck, faChevronDown, faChevronLeft, faChevronRight, faCircleNotch,
  ...
  faWandMagicSparkles, faMobileScreenButton, faArrowUpFromBracket, faSquarePlus, faSwatchbook,
  faBell, faBellSlash, faDownload,
